        ...
        <div class="card-body">
            ...
            <div id="basic-pills-wizard" class="twitter-bs-wizard">
                <ul class="twitter-bs-wizard-nav">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('user.profile',['page'=>2])); ?>" class="nav-link">
                ...
                <div class="tab-content twitter-bs-wizard-tab-content">
                    ...
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">NID Number</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="<?php echo e(old('nid_number',isset($profile) ?$profile->nid_number:'')); ?>" name="nid_number" placeholder="">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3 mb-2">
                                <div class="card">
                                    <div class="card-body pt-2  pb-2">
                                        <p class="card-title">Photo<span class="text-danger">*</span></p>
                                        ...
                                        <small class="text-danger">Photo is required</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 mb-2">
                                <div class="card">
                                    <div class="card-body pt-2  pb-2">
                                        <p class="card-title">NID</p>
                                        <input  type="file"  name="nid_image"  class="form-control dropify" data-default-file="<?php echo e(old('nid_image',isset($profile) ?$profile->nid_image:'')); ?>" >
                            ...
                            <div class="col-sm-3 mb-2">
                                <div class="card">
                                    <div class="card-body pt-2 pb-2">
                                        <p class="card-title">ETIN/TIN</p>
                                        <input type="file"  name="etin_image"  class="form-control dropify" data-default-file="<?php echo e(old('etin_image',isset($profile) ?$profile->tin_image:'')); ?>" >
                                        <small class="text-danger"><br></small>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/frontend/profile/step-one.blade.php ENDPATH**/ ?>