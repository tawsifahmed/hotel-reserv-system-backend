        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content p-0 text-muted">
                    <div class="tab-pane active" id="Pending" role="tabpanel" style="height: 225px;overflow: auto;">
                    ...
                    <div class="tab-pane" id="Partial" role="tabpanel"  style="height: 225px;overflow: auto;">
                        <table class="table table-hover mb-0 table-centered table-nowrap">
                            <tbody>
...
<?php /**PATH D:\laragon\www\club-management-system\resources\views/frontend/dashboard/dashboard-analytics.blade.php ENDPATH**/ ?>