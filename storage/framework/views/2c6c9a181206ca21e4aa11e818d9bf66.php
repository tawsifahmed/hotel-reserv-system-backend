    ...
    <div class="col-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.club-service.update',$type->id)); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo method_field('PUT'); ?>

                     <?php echo csrf_field(); ?>
                    <div class="form-group mb-3">
                        <label for="name">Service Name *</label>
                        <input required type="text" class="form-control form-control-danger" id="name" name="title" autocomplete="off" placeholder="Service Name" value="<?php echo e(old('title', isset($type) ? $type->title : '')); ?>" aria-invalid="true">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required type="number" class="form-control form-control-danger" id="price" name="price" autocomplete="off" placeholder="Service Price" value="<?php echo e(old('price', isset($type) ? $type->price : '')); ?>" aria-invalid="true">
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/administrative/club-service/edit.blade.php ENDPATH**/ ?>