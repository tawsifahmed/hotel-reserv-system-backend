    ...
    <div class="col-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.model.update',$data->id)); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo method_field('PUT'); ?>
                     ...
                     <div class="form-group mb-3">
                        ...
                        <select id="brand_id" name="brand_id" class="form-select select2" required>
                            ...
                            <option value="<?php echo e($brand->id); ?>" <?php echo e($data->brand_id == $brand->id?'selected':''); ?>><?php echo e($brand->name); ?></option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="charger_type_id" name="charger_type_id" class="form-select select2" required>
                            <option disabled>Select Charger</option>
                            ...
                            <option value="<?php echo e($type->id); ?>"  <?php echo e($type->charger_type_id == $type->id?'selected':''); ?>><?php echo e($type->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <a href="<?php echo e(route('administrative.model')); ?>" class="btn btn-light">Cancel</a>
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\b-charging\resources\views/administrative/model/edit.blade.php ENDPATH**/ ?>