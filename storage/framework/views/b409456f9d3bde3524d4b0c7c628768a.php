        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Restaurant settings Edit</h4>
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.restaurant-settings.update',$type->id)); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo method_field('PUT'); ?>

                     <?php echo csrf_field(); ?>
                     <div class="form-group mb-3">
                        <label for="name">Restaurant Prefix *</label>
                        <input required type="text" class="form-control form-control-danger" id="name" name="title" autocomplete="off" placeholder="Restaurant Prefix" value="<?php echo e(old('title', isset($type) ? $type->title : '')); ?>" aria-invalid="true">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input required type="number" step="0.01" class="form-control form-control-danger" id="commission" name="commission" autocomplete="off" placeholder="Commission Percentage" value="<?php echo e(old('commission', isset($type) ? $type->commission : '')); ?>" aria-invalid="true">
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/administrative/restaurant-settings/edit.blade.php ENDPATH**/ ?>