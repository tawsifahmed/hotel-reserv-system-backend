                    ...
                    <div class="card-body">
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" value="<?php echo e(old('phone_number')); ?>" name="phone_number" placeholder="">
                                </div>
                            </div>
                            <div class="row mb-3">
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\club-management-system\resources\views/index.blade.php ENDPATH**/ ?>
