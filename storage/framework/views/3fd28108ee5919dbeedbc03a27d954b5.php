...
<html lang="en">
  ...
  <body  style="margin: auto; color: #023b67;">
    <style>
      @font-face {
        font-family: "BebasNeueBold";
        font-style: normal;
        src: url(<?php echo e(asset('assets/fonts/BebasNeue-Bold.ttf')); ?>);
      }
      .details {
      ...
      <tr>
        <td>
          <table style="width: 100%">
            ...
            <tbody>
              <td>
                <img src="<?php echo e($profile->logo); ?>" alt="" style="height: 150px;width: auto"  />
              </td>
              ...
              <td>
                ...
                >
                  <img
                    src="<?php echo e($profile->thumbnail); ?>"
                    alt=""
                     style="height: 200px; width: 180px;border: 1px solid #ededed;padding:5px"
                  />
                </div>
              </td>
            </tbody>
...
<?php /**PATH D:\laragon\www\club-management-system\resources\views/frontend/profile/profile-web.blade.php ENDPATH**/ ?>
