        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('administrative.dashboard')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" alt="logo-sm-light" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" alt="logo-light" height="60">
                    </span>
                </a>
            </div>
...
<?php /**PATH D:\laragon\www\testing_by_fiz\Rony\motor-backend\resources\views/administrative/layouts/partial/_navbar.blade.php ENDPATH**/ ?>