    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.invoice.store')); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row mb-3">
                        <div class="col-sm-6">
                                ...
                                <?php if(count($invoices) > 0): ?>
                                    ...
                                    <tr class="">
                                        <td colspan="100%">
                                            ...
                                            <textarea  class="form-control" min="0" name="note" id="note"><?php echo e(old('note')); ?></textarea>
                                        </td>
                                    </tr>
                                <?php else: ?>
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/administrative/invoice/create.blade.php ENDPATH**/ ?>