                    ...
                    <div class="card-body">
                        ...
                        <form id="create-profile" enctype="multipart/form-data" action="<?php echo e(route('member.create')); ?>"
                            ...
                            <div class="form-section">
                                <div class="row mb-3">
                                    <label for="example-month-input" class="col-sm-2 col-form-label">Type of Member<span
                                        ...
                                        <?php $__currentLoopData = $typeMembership; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="radio-inline mb-0">
                                                <div class="form-check" style="margin-right: 15px;">
                                                    <input class="form-check-input" <?php echo e($key == 0 ? 'checked' : ''); ?>

                                                        value="<?php echo e($type->id); ?>"
                                                        <?php echo e(old('type_of_member') == $type->id ? 'checked' : ''); ?>

                                                        type="radio" name="type_of_member"
                                                        id="permanent<?php echo e($type->id); ?>">
                                                    <label class="form-check-label capitalize"
                                                        for="permanent<?php echo e($type->id); ?>">
                                ...
                                <div class="row mb-3">
                                    <label for="name" class="col-sm-2 col-form-label">Name<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input class="form-control" required type="text" value="<?php echo e(old('name')); ?>"
                                            name="name" placeholder="" id="name">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" required type="date"
                                            value="<?php echo e(old('date_of_birth')); ?>" name="date_of_birth" value="">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">NID Number<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" required type="text"
                                            value="<?php echo e(old('nid_number')); ?>" name="nid_number" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Passport Number<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" type="text" name="passport_number"
                                            value="<?php echo e(old('passport_number')); ?>" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <input required type="file" name="image" class="form-control dropify"
                                            data-default-file="<?php echo e(old('image')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <input required type="file" name="nid_image" class="form-control dropify"
                                            data-default-file="<?php echo e(old('nid_image')); ?>">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">ETIN/TIN<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-3 mb-2">
                                        <input required type="file" name="etin_image" class="form-control dropify"
                                            data-default-file="<?php echo e(old('etin_image')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div id="education-container">
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Name of Institution<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" type="text"
                                                name="education[1][name_of_institution]" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Year<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" name="education[1][year]" type="date"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input required class="form-control" type="text"
                                                name="education[1][degree]" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="">
                                        <button id="add-more-education-btn" class="btn btn-light btn-sm"
                                            style="float: right">
                            ...
                            <div class="form-section">
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Marital Status<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10  pt-2">
                                        <label class="form-inline">
                                            <div class="form-check" style="margin-right: 15px;">
                                                <input class="form-check-input" value="Married"
                                                    <?php echo e(old('marrital_status') == 'Married' ? 'checked' : ''); ?>

                                                    type="radio" name="marrital_status" id="Married">
                                        ...
                                        <label class="form-inline">
                                            <div class="form-check" style="margin-right: 15px;">
                                                <input class="form-check-input" value="single" checked
                                                    <?php echo e(old('marrital_status') == 'single' ? 'checked' : ''); ?>

                                                    type="radio" name="marrital_status" id="single">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="date"
                                            value="<?php echo e(old('date_of_anniversary')); ?>" name="date_of_anniversary"
                                            placeholder="">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">No of Dependents<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" type="number"
                                            value="<?php echo e(old('no_of_dependents')); ?>" name="no_of_dependents"
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Father's Name<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" type="text"
                                            value="<?php echo e(old('father_name')); ?>" name="father_name" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Mother's Name<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" type="text"
                                            value="<?php echo e(old('mother_name')); ?>" name="mother_name" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Mobile Number<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" required type="text"
                                            value="<?php echo e(old('mobile_number')); ?>" name="mobile_number" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Phone Number</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="<?php echo e(old('phone_number')); ?>"
                                            name="phone_number" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Email ID<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <input required class="form-control" required type="text"
                                            value="<?php echo e(old('email_id')); ?>" name="email_id" placeholder="">
                                        <?php if($errors->has('email_id')): ?>
                                            <small id="email_id-error" class="error mt-2 text-danger"
                                                for="email_id"><?php echo e($errors->first('email_id')); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Permanent Address<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Present Address<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="<?php echo e(old('office_mobile')); ?>" type="text" name="office_mobile" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="<?php echo e(old('office_phone')); ?>" type="text" name="office_phone" placeholder="">
                                    </div>
                                </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\club-management-system\resources\views/welcome.blade.php ENDPATH**/ ?>