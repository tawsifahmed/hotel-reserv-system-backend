        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Charger Type Edit</h4>
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.charger-type.update',$type->id)); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo method_field('PUT'); ?>

                     <?php echo csrf_field(); ?>
                     <div class="form-group mb-3">
                        <label for="name">Name *</label>
                        <input required type="text" class="form-control form-control-danger" id="name" name="name" autocomplete="off" placeholder="Charger Name" value="<?php echo e(old('name', isset($type) ? $type->name : '')); ?>" aria-invalid="true">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control form-control-danger" id="details" name="details" autocomplete="off" placeholder="Charger details" aria-invalid="true"><?php echo e(old('details', isset($type) ? $type->details : '')); ?></textarea>
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\b-charging\resources\views/administrative/charger-type/edit.blade.php ENDPATH**/ ?>