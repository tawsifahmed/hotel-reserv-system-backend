    ...
    <div class="col-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.user.store')); ?> " method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" id="roles" class="form-select" required>
                            ...
                            <option value="<?php echo e($id); ?>" <?php echo e(isset($data) && $data->roles->first()->id == $id ? 'selected' : ''); ?>> <?php echo e($role); ?></option>
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/administrative/user/create.blade.php ENDPATH**/ ?>