        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Instance Edit</h4>
                ...
                <form class="needs-validation" novalidate action="<?php echo e(route('administrative.instance.update', $data->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required type="datetime-local" class="form-control form-control-danger"
...
<?php echo $__env->make('administrative.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\club-management-system\resources\views/administrative/instance/edit.blade.php ENDPATH**/ ?>