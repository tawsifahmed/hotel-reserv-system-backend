<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            <a href="<?php echo e(route('administrative.station')); ?>" class="waves-effect">
        ...
        <li>
            <a href="<?php echo e(route('administrative.vehicle')); ?>" class="waves-effect">
...
<?php /**PATH D:\laragon\www\b-charging\resources\views/administrative/layouts/partial/_sidebar.blade.php ENDPATH**/ ?>